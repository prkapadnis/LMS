...
<div class="w3-sidebar w3-green w3-bar-block" style="width:20%">
    ...
    <a href="#" class="w3-bar-item w3-button w3-center"> <b> Available Magzine </b> </a>
...
if(mysqli_num_rows($result) > 0) {
    while($row=mysqli_fetch_array($result)) {
        ...
        echo " <tr> 
			<td>".$row['Id']."</td> 
			<td>".$row['magzineName']."</td> 
			<td>".$row['quantity']."</td> 
			<td> ".$row['Price']."</td>
			<td> ".$row['description']."</td>
			<td> 
                <a class='w3-round-xxlarge w3-btn' href ='editMagzine.php?Id=$i'> Edit </a>			
			</td>
			<td>
			    <a class='w3-round-xxlarge w3-btn' href ='deletemagzine.php?Id=$i'> Delete </a>
            </td>
			</tr>";
    }
}
